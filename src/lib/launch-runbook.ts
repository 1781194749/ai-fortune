...
const templates = [
  ...
  },
  {
    ...
    groupId: "account",
    groupTitle: "账号登录",
    title: "确认邮箱登录与微信扫码登录配置",
    owner: "技术 / 运营",
    why: "第一版必须保证邮箱登录可用，国内转化会继续受益于微信扫码登录。",
    action: "保持 AUTH_EMAIL_ENABLED=true；微信开放平台完成后配置 WECHAT_APP_ID、WECHAT_APP_SECRET，并灰度验证扫码绑定账号。",
    evidence: "邮箱验证码登录可创建或恢复用户；微信扫码登录完成后可创建或恢复同一用户。",
    relatedCheckIds: [
      "check:wechat-login",
