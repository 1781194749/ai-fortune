...
function runStaticChecks(result, root) {
  ...
  checkContainsAll(result, {
    ...
    content: [
      ...
      readProjectFile(root, "src/app/admin/admin-section-content.tsx"),
      readProjectFile(root, "src/lib/admin-dashboard.ts"),
  ...
  checkContainsAll(result, {
    ...
    readyDetail: "深度报告会员额度由服务层在事务内创建任务并扣账本，扣成功后启动生成。",
  ...
  checkContainsAll(result, {
    ...
    tokens: [
      ...
      "refundMemberEntitlement",
      "深度报告生成最终失败，退回 1 份会员报告额度",
      "entitlementRefundTransactionId",
      "dispatchAcceptedJob",
    ],
    readyDetail: "会员额度深度报告在生成最终失败时会幂等退回额度。",
